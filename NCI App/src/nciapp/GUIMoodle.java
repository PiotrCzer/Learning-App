 ...
 * @author x12383876
 */
public class GUIMoodle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mainMoodle = new javax.swing.JLabel();
        moodleButton = new javax.swing.JButton();
        MoodleBanner = new javax.swing.JLabel();
        ...
        mainMoodle.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        mainMoodle.setForeground(new java.awt.Color(255, 255, 255));
        mainMoodle.setText("<html> Moodle is where all your modules are connected. You can go here to view word documents, powerpoint slides and download them. \n<br/><br/> You will also find details about your in class tests and moodle quizzes.\n\n<br/><br/> You log in with your student number and password.");
        getContentPane().add(mainMoodle);
        mainMoodle.setBounds(60, 100, 240, 200);
        ...
        moodleButton.setBounds(120, 330, 120, 50);

        MoodleBanner.setFont(new java.awt.Font("Calibri", 1, 36)); // NOI18N
        MoodleBanner.setForeground(new java.awt.Color(255, 255, 255));
        MoodleBanner.setText("Moodle");
        getContentPane().add(MoodleBanner);
        MoodleBanner.setBounds(230, 10, 115, 30);
    ...
    private void moodleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_moodleButtonActionPerformed
        // TODO add your handling code here:
        try {
        String URL ="https://moodle.ncirl.ie/my/";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIMoodle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new GUIMoodle().setVisible(true);
            }
        });
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel MenuBar;
    private javax.swing.JLabel MoodleBanner;
    private javax.swing.JLabel Wallpaper;
    private javax.swing.JLabel mainMoodle;
